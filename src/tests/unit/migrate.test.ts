...
import { FailedDataElement, DataElement } from "../../models";
...
let failQueue: FailedDataElement | undefined;
...
describe("Migration Tests", () => {
  ...
  > => {
    ...
    failQueue = new FailedDataElement();
    ...
    const savedFailQueue: FailedDataElement = await connection.manager.save(
      failQueue
    );
